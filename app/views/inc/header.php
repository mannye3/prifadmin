...
<head>
        ...
        <!-- App css -->
        <link href="<?php echo URLROOT; ?>/public/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo URLROOT; ?>/public/assets/css/icons.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo URLROOT; ?>/public/assets/css/metismenu.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo URLROOT; ?>/public/assets/css/style.css" rel="stylesheet" type="text/css" />
  ...
  <!--venobox lightbox-->
        ...
        <script src="<?php echo URLROOT; ?>/public/assets/js/modernizr.min.js"></script>
