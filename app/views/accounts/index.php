                                        ...
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-4">
                                                <div class="card-box widget-flat border-custom bg-custom text-white">
                                                    <i class="fi-tag"></i>
                                                    <h3 class="m-b-10"><?php echo $data['listing_num_pro']->TotalCountProperty;  ?></h3>
                                            ...
                                            <div class="col-xs-6 col-sm-4">
                                                <div class="card-box bg-primary widget-flat border-primary text-white">
                                                    ...
                                                    <h3 class="m-b-10"><?php echo $data['listing_num_agent']->TotalCountAgents;  ?></h3>
                                                    <p class="text-uppercase m-b-5 font-13 font-600">Total Agents</p>
                                                </div>
                                            </div>
                                            <div class="col-xs-6 col-sm-4">
